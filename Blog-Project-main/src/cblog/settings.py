...
DATABASES = {
    'default': {
        ...
        'HOST': 'project-blog-db.cd7ugzscifwc.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blog-s3-kursat' # please enter your s3 bucket name
